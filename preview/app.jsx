...
const APP_COMMIT     = "2ff016b";
const APP_BUILD_DATE = "2026-07-30T00:16:48";
  ...
  return (
    <div style={{
      ...
      {/* (4.5) Drift parallax starfield -- NOT part of the Figma 145-3068
          ...
          on. Two dot layers scroll the same direction as the drift shift,
          slower than the board (board moves CELL/DRIFT_TICK_MS =~9px/s;
          far layer ~1.4px/s, near layer ~3.6px/s), so the board reads as
          riding a surface instead of sliding over a dead backdrop. */}
      {settings.drift && (
        <React.Fragment>
          <div style={{
            position: "absolute", inset: 0,
